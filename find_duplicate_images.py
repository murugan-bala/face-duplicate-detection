...
IMAGE_DIR = 'E:\\Face Detection\\DEMO 2\\image'
...
print("Total Images in the Database : ",total_img)

#print(image_files[0])       #'amu - Copy.jpg'

#imread(image_files[0]).shape    # (531, 413, 3)
...
print("Duplicate image found : ",len(duplicates))

#Show the duplicate images
inp=input("Do you want to show duplicate image ???, Press (y/n)")
if inp=='y':    
    for file_names in duplicates[:total_img]:
        try:
